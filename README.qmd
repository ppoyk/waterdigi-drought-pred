...
format:
  html:  # create html for project website and md for viewing the repo
    title-block-banner: false
  gfm:   # github-flavoured-md.  use "hugo" or `variant: +yaml_metadata_block` if header should be preserved
    title-block-banner: false
subtitle: "README"
---
<!--
...
Similar bad time series were very prevalent across the dataset:
