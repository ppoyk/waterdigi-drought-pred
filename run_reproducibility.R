...
# First, the environment consistency is ensured using `renv`.
...
quarto::quarto_render("SE3_modelling_steps.qmd", OUT_FORMAT)
message("✅")

cat("Creating visualizations and the data story...")
quarto::quarto_render("SE4_results_viz.qmd", OUT_FORMAT)
message("✅")

cat("Building README...")
quarto::quarto_render("README.md", OUT_FORMAT)
message("✅")
