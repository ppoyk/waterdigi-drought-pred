...
|               | Environment        | ments of GW level   |          | https://syke.fi/en/environmental-data/maps-and-information-services/open-environmental-information-systems) |                                               | Institute, Economic               |
...
| precipitation | Institute](        | observations        |          | [Metadata](https://paikkatietohakemisto.fi/geonetwork/srv/api/records/b5ac0243-3da6-47ed-96b0-1867cdeda838) |                                               |                                   |
|               | https://fmi.fi/en) |                     |          |                                                                                                             |                                               |                                   |
+---------------+--------------------+---------------------+----------+-------------------------------------------------------------------------------------------------------------+-----------------------------------------------+-----------------------------------+
...
[Hertta](https://www.syke.fi/en/environmental-data/maps-and-information-services/open-environmental-information-systems),
the open data portal of the [Finnish Environment Institute](syke.fi/en), requires the creation
of a free user account. The portal is mostly available in English. There is no single selection
